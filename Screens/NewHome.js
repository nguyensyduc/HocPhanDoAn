...
import { setCurrentJobs } from "../Store/userSlice";
const NewHomeScreen = ({ navigation, route }) => {
    ...
    return (
        <View style={{ flex: 1, backgroundColor:'#fff' }}>
            ...
            <Text style={{ fontSize: 22, marginVertical: 20, paddingHorizontal: 5 }}>Các không gian làm việc của bạn</Text>
            <View style={[styles.horizontalView, { justifyContent: 'space-between', borderBottomWidth: 2, padding: 10 }]}>
                <View style={styles.horizontalView}>
                    ...
                    <Text style={{ fontSize: 20, fontWeight: '600' }}>Công việc của {userInfor.username}</Text>
                </View>
                <TouchableOpacity>
                ...
                : (
                    memberStatus.toString() ?
                        <FlatList
                            ...
                            renderItem={({ item }) => {
                                return (
                                    <View style={[styles.horizontalView, { justifyContent: 'space-between', borderBottomWidth: 1, borderColor: 'gray', padding: 10, marginHorizontal: 15 }]}>
                                        <View style={[styles.horizontalView, { width: '90%' }]}>
                                            ...
                                            <Text style={{ fontSize: 15, width: '70%', textAlign: 'justify' }}>{item.name}</Text>
                                        </View>
                                        <TouchableOpacity
                                            style={{ width: '10%' }}
                                            onPress={() => {
